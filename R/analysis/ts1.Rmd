...
-   このノートではHagiwara Junichiro先生のTime Series Analysis for the State-Space Model with R/Stanで紹介されている分析を個人的に関心のあるデータに適用しながら、追っています。



以下で公開されていたデータセットを取得し使用しています。
